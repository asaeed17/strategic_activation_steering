#!/usr/bin/env python3
"""
Final 7B grid runner for shoveler-l — BATCH 1.
Dimensions: composure, flattery, spite, undecidedness (4 dims x 9 layers x 2 alphas = 72 configs @ n=50)
...
DIMENSIONS = ["composure", "flattery", "spite", "undecidedness"]
