#!/usr/bin/env python3
"""
Overnight batch runner for scoter-l.
Layer gradient dose-response completion for firmness and empathy.

2 dims x 7 layers x 2 alphas = 28 configs at n=50.
...
def main():
    ...
    print(f"\n{'=' * 70}")
    print(f"OVERNIGHT SCOTER-L: Layer Gradient v2 ({total} configs @ n={N_GAMES})")
    ...
    out_dir = Path("results/ultimatum/layer_gradient_v2")
