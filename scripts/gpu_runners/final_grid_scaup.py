#!/usr/bin/env python3
"""
Final 7B grid runner for scaup-l — BATCH 1.
Dimensions: firmness, empathy, anchoring (3 dims x 9 layers x 2 alphas = 54 configs @ n=50)
...
DIMENSIONS = ["firmness", "empathy", "anchoring"]
